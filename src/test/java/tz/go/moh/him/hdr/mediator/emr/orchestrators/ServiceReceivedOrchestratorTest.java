...
/**
 * Contains tests for the {@link ServiceReceivedOrchestrator} class.
 */
public class ServiceReceivedOrchestratorTest extends BaseOrchestratorTest {
    /**
     * Represents the orchestrator.
     */
    private final ActorRef orchestrator = system.actorOf(Props.create(ServiceReceivedOrchestrator.class, configuration));
    ...
    public void testBadRequest() throws Exception {
        InputStream stream = ServiceReceivedOrchestratorTest.class.getClassLoader().getResourceAsStream("bad_request.json");
        assertNotNull(stream);
