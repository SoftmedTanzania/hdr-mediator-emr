package tz.go.moh.him.hdr.mediator.emr;
...
public class MediatorMainTest {
    ...
    public void mediatorMainTest() throws Exception {
        ...
        MediatorConfig mediatorConfig = (MediatorConfig) loadConfigMethod.invoke(null, "src/test/resources/mediator-unit-test.properties");

        Assert.assertEquals("localhost", mediatorConfig.getServerHost());
        Assert.assertEquals(new Integer(3000), mediatorConfig.getServerPort());
