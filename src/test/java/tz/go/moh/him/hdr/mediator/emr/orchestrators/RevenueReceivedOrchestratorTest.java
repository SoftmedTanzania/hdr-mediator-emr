...
/**
 * Contains tests for the {@link RevenueReceivedOrchestrator} class.
 */
public class RevenueReceivedOrchestratorTest extends BaseOrchestratorTest {
    /**
     * Represents the orchestrator.
     */
    private final ActorRef orchestrator = system.actorOf(Props.create(RevenueReceivedOrchestrator.class, configuration));
    ...
    public void testMediatorHTTPRequest() throws Exception {
        InputStream stream = RevenueReceivedOrchestratorTest.class.getClassLoader().getResourceAsStream("revenue_received_request.json");
